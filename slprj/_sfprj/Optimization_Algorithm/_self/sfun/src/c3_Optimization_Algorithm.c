...
#include <stddef.h>
#include "blas.h"
#include "Optimization_Algorithm_sfun.h"
#include "c3_Optimization_Algorithm.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "Optimization_Algorithm_sfun_debug_macros.h"
...
static void initialize_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void initialize_params_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void enable_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void disable_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void set_sim_state_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void sf_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void c3_chartstep_c3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void initSimStructsc3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static void registerMessagesc3_Optimization_Algorithm
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance);
static real_T c3_plus_proche(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, real_T c3_tab[48], real_T c3_val);
static real_T c3_b_plus_proche(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, real_T c3_tab[81], real_T c3_val);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_alpha_opt, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[567]);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[336]);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[7]);
...
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_f_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[48]);
...
static const mxArray *c3_f_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_g_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[81]);
...
static void c3_h_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y_data[101], int32_T c3_y_sizes[2]);
...
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_i_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[401]);
...
static const mxArray *c3_i_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_j_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[2800]);
...
static void c3_eml_scalar_eg(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance);
static void c3_float_colon_length(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, real_T c3_a, real_T c3_b, int32_T *c3_n, real_T *c3_anew,
  real_T *c3_bnew, boolean_T *c3_n_too_large);
static real_T c3_mpower(SFc3_Optimization_AlgorithmInstanceStruct *chartInstance,
  real_T c3_a, real_T c3_b);
static void c3_eml_error(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance);
static void c3_sum(SFc3_Optimization_AlgorithmInstanceStruct *chartInstance,
                   real_T c3_x[2800], real_T c3_y[7]);
static const mxArray *c3_j_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_k_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_j_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_l_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_Optimization_Algorithm, const
  char_T *c3_identifier);
static uint8_T c3_m_emlrt_marshallIn(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Optimization_AlgorithmInstanceStruct
  *chartInstance);
  ...
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Optimization_Algorithm = 0U;
}
  ...
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_Optimization_Algorithm;
   ...
   *c3_st)
{
  ...
  *c3_alpha_opt = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 0)), "alpha_opt");
  chartInstance->c3_is_active_c3_Optimization_Algorithm = c3_l_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_Optimization_Algorithm");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Optimization_Algorithm(chartInstance);
  ...
  (SFc3_Optimization_AlgorithmInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Optimization_Algorithm(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Optimization_AlgorithmMachineNumber_,
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Optimization_AlgorithmInstanceStruct *chartInstance;
  chartInstance = (SFc3_Optimization_AlgorithmInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Optimization_Algorithm_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_m_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Optimization_Algorithm), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Optimization_Algorithm);
  return c3_y;
}
...
void sf_c3_Optimization_Algorithm_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Optimization_Algorithm_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_Optimization_Algorithm_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_Optimization_Algorithm(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha_opt\",},{M[8],M[0],T\"is_active_c3_Optimization_Algorithm\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Optimization_Algorithm_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_Optimization_AlgorithmInstanceStruct *chartInstance;
    chartInstance = (SFc3_Optimization_AlgorithmInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _Optimization_AlgorithmMachineNumber_,
           3,
           1,
           1,
           16,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_Optimization_AlgorithmMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Optimization_AlgorithmMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Optimization_AlgorithmMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c3_Optimization_Algorithm(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_Optimization_AlgorithmInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_Optimization_Algorithm
    ((SFc3_Optimization_AlgorithmInstanceStruct*) chartInstanceVar);
  initialize_c3_Optimization_Algorithm
    ((SFc3_Optimization_AlgorithmInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Optimization_Algorithm(void *chartInstanceVar)
{
  enable_c3_Optimization_Algorithm((SFc3_Optimization_AlgorithmInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_Optimization_Algorithm(void *chartInstanceVar)
{
  disable_c3_Optimization_Algorithm((SFc3_Optimization_AlgorithmInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_Optimization_Algorithm(void *chartInstanceVar)
{
  sf_c3_Optimization_Algorithm((SFc3_Optimization_AlgorithmInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_Optimization_Algorithm
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Optimization_Algorithm
    ((SFc3_Optimization_AlgorithmInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_Optimization_Algorithm();/* state var info */
...
extern void sf_internal_set_sim_state_c3_Optimization_Algorithm(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_Optimization_Algorithm
    ((SFc3_Optimization_AlgorithmInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_Optimization_Algorithm
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Optimization_Algorithm(S);
}

static void sf_opaque_set_sim_state_c3_Optimization_Algorithm(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_Optimization_Algorithm(S, st);
}

static void sf_opaque_terminate_c3_Optimization_Algorithm(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Optimization_AlgorithmInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Optimization_Algorithm_optimization_info();
    }

    finalize_c3_Optimization_Algorithm
      ((SFc3_Optimization_AlgorithmInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Optimization_Algorithm
    ((SFc3_Optimization_AlgorithmInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Optimization_Algorithm(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_Optimization_Algorithm
      ((SFc3_Optimization_AlgorithmInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_Optimization_Algorithm(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Optimization_Algorithm_optimization_info();
...
static void mdlRTW_c3_Optimization_Algorithm(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Optimization_Algorithm(SimStruct *S)
{
  SFc3_Optimization_AlgorithmInstanceStruct *chartInstance;
  chartInstance = (SFc3_Optimization_AlgorithmInstanceStruct *)utMalloc(sizeof
    (SFc3_Optimization_AlgorithmInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Optimization_AlgorithmInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Optimization_Algorithm;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Optimization_Algorithm;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Optimization_Algorithm;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_Optimization_Algorithm;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_Optimization_Algorithm;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Optimization_Algorithm;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Optimization_Algorithm;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Optimization_Algorithm;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Optimization_Algorithm;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Optimization_Algorithm;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Optimization_Algorithm;
...
void c3_Optimization_Algorithm_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Optimization_Algorithm(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Optimization_Algorithm(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Optimization_Algorithm(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Optimization_Algorithm_method_dispatcher.\n"
